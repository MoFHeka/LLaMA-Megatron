...
_TRAINERSPEC = DESCRIPTOR.message_types_by_name['TrainerSpec']
_NORMALIZERSPEC = DESCRIPTOR.message_types_by_name['NormalizerSpec']
_SELFTESTDATA = DESCRIPTOR.message_types_by_name['SelfTestData']
_SELFTESTDATA_SAMPLE = _SELFTESTDATA.nested_types_by_name['Sample']
_MODELPROTO = DESCRIPTOR.message_types_by_name['ModelProto']
_MODELPROTO_SENTENCEPIECE = _MODELPROTO.nested_types_by_name['SentencePiece']
_TRAINERSPEC_MODELTYPE = _TRAINERSPEC.enum_types_by_name['ModelType']
_MODELPROTO_SENTENCEPIECE_TYPE = _MODELPROTO_SENTENCEPIECE.enum_types_by_name['Type']
